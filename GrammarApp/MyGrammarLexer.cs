...
public partial class MyGrammarLexer : Lexer {
    ...
    public void mINTEGER() // throws RecognitionException [2]
    {
            ...
            int _type = INTEGER;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // MyGrammar.g:95:9: ( ( '0' .. '9' )+ )
            // MyGrammar.g:95:11: ( '0' .. '9' )+
            {
            	// MyGrammar.g:95:11: ( '0' .. '9' )+
            	int cnt1 = 0;
            	do 
    ...
    public void mREAL() // throws RecognitionException [2]
    {
            ...
            int _type = REAL;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // MyGrammar.g:98:6: ( INTEGER '.' INTEGER )
            // MyGrammar.g:98:8: INTEGER '.' INTEGER
            {
            	mINTEGER(); 
            	Match('.'); 
            	mINTEGER(); 
    ...
    public void mID() // throws RecognitionException [2]
    {
            ...
            int _type = ID;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // MyGrammar.g:105:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
            // MyGrammar.g:105:7: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            {
            	...
            	// MyGrammar.g:105:31: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            	do 
            	{
            	    int alt2 = 2;
    ...
    public void mWS() // throws RecognitionException [2]
    {
            ...
            int _type = WS;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // MyGrammar.g:257:3: ( ( ' ' | '\\t' | '\\f' | '\\r' | '\\n' )+ )
            // MyGrammar.g:258:3: ( ' ' | '\\t' | '\\f' | '\\r' | '\\n' )+
            {
            	// MyGrammar.g:258:3: ( ' ' | '\\t' | '\\f' | '\\r' | '\\n' )+
            	int cnt3 = 0;
            	do 
    ...
    {
        // MyGrammar.g:1:8: ( PRINT | PLUS | MINUS | MULTIPLY | DIVIDE | IF | ELSE | BLOCK | CONDITION | ASSIGN | PLUSASSIGN | MINUSASSIGN | MULTASSIGN | DIVIDEASSIGN | INCREMENT | DECREMENT | INT | FLOAT | DOUBLE | CHAR | VOID | PRIVATE | PUBLIC | CALLMETHOD | FOR | WHILE | INCREMENT_ | T__48 | T__49 | T__50 | T__51 | T__52 | T__53 | T__54 | T__55 | T__56 | T__57 | T__58 | T__59 | T__60 | T__61 | T__62 | T__63 | INTEGER | REAL | ID | WS )
        int alt4 = 47;
